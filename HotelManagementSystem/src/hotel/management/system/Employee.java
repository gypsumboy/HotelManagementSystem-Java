...
public class Employee extends JFrame {
    ...
    public Employee() throws SQLException {
        ...
        btnLoadData.setBounds(500, 500, 120, 30);
        ...
        btnExit.setBounds(660, 500, 120, 30);
        ...
        lblJob.setBounds(245, 11, 25, 14);
        contentPane.add(lblJob);

        lblName = new JLabel("Gender");
        lblName.setBounds(395, 11, 46, 14);
        contentPane.add(lblName);

        lblDepartment = new JLabel("Job");
        lblDepartment.setBounds(565, 11, 86, 14);
        contentPane.add(lblDepartment);

        JLabel l1 = new JLabel("Salary");
        l1.setBounds(720, 11, 86, 14);
        contentPane.add(l1);

        JLabel l2 = new JLabel("Phone");
        l2.setBounds(880, 11, 86, 14);
        contentPane.add(l2);

        JLabel l3 = new JLabel("Gmail");
        l3.setBounds(1040, 11, 100, 14);
        contentPane.add(l3);

        JLabel l4 = new JLabel("Aadhar");
        l4.setBounds(1195, 11, 86, 14);
        contentPane.add(l4);
