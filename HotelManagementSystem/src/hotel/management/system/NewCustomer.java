...
public class NewCustomer extends JFrame {
    ...
    public NewCustomer() throws SQLException {
        ...
        r1.setBounds(270, 191, 70, 12);
        add(r1);

        r2 = new JRadioButton("Female");
        r2.setFont(new Font("Raleway", Font.BOLD, 14));
        r2.setBackground(Color.WHITE);
        r2.setBounds(344, 191, 100, 12);
        add(r2);
        ...
        lblReserveRoomNumber.setFont(new Font("Tahoma", Font.BOLD, 15));
        ...
        lblCheckInStatus.setFont(new Font("Tahoma", Font.BOLD, 15));
        ...
        btnNewButton.setFont(new Font("Raleway",Font.BOLD,15));
